(ns marketentry.registry
  ...
  Like Armenia's own registry, this namespace carries NO numeric
  statutory-threshold recompute of its own -- MDA's flagship governor
  check (`marketentry.governor/interdiction-list-violations`) is a
  plain registry-membership boolean read off the engagement record,
  grounded in Legea nr. 131/2015 + Hotărârea Guvernului nr. 1418 din
  28.12.2016 (see `marketentry.facts`), not a computed formula, so
